  ...
  return (
    <div className="flex flex-row w-full h-[100px] justify-between items-center bg-[#F9F1E7] px-[10px] l:px-[100px]">
        <div className="flex flex-row">
          <Link href="/" className="text-[16px] text-[#9F9F9F] font-[400] ml-[7px] extrasml:ml-[12px] mr-[5px] extrasml:mr-[14px] hover:underline mont">Home</Link>
          <Image src={arrow} alt="icon" className="mr-[7px] extrasml:mr-[24px]"/>
          <Link href="/shop" className="text-[16px] text-[#9F9F9F] font-[400] ml-[12px] mr-[5px] extrasml:mr-[14px] mont hover:underline">Shop</Link>
          <Image src={arrow} alt="icon" className="mr-[7px] extrasml:mr-[24px]"/>
